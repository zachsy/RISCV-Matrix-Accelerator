module tb_systolic_array();
    ...
    localparam int N = 4;               // Size of array. Should match systolic_array.sv and generate_accelerator_tests.py
    localparam int NUM_TESTS = 1005;    // Total number of matrices generated by generate_array_tests.py
